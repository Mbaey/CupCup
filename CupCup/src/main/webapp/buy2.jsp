...
<body>
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="recipient-name"
								placeholder="please input your name" style="width: 250px">
						</div>
						<div class="form-group">
							<label for="message-text" class="control-label">password:</label>
							<input type="text" class="form-control" id="recipient-name"
								placeholder="please input your password" style="width: 250px">
						</div>
						<div style="float: right; margin-top: -125px">
							<img src="img/lo.png">
						</div>
						<input type="submit" value="提交" class="btn btn-primary"
							style="float: right; background-color: #ef4238;">
					</form>
				</div>
	...
	<div style="width: 980px; height: 718px; margin: 0px auto;">
		<div id="goupiao">
			...
			<div id="artical">
				<br />
				<hr
					style="height: 1px; border: none; border-top: 1px dotted #DDDDDD; width: 680px; margin-left: 20px" />
				...
				<div>
					...
					<div id="xuanzuo">
						...
						<ul style="cursor: pointer">
							...
							<li class="zuo" id="133" style="border: #FFF solid 1px;"></li>
							</a>
						...
						<ul style="cursor: pointer">
							...
							<li class="zuo" id="140" style="border: #FFF solid 1px;"></li>
							</a>
						...
						<ul style="cursor: pointer">
							...
							<li class="zuo" id="149" style="border: #FFF solid 1px;"></li>
							</a>
		...
		<div id="goupiaoxinxi">
			<div style="width: 100%; height: 138px">
				<img
					style="width: 70px; height: 103px; float: left; margin-top: 16px; margin-left: 15px"
					src="${sessionScope.movie.cover }">
				<div class="xuanzuobiaoti">
					<a style="color: #000" href="#">${sessionScope.movie.title }</a>
				</div>
			</div>
			<p style="margin-left: 100px; margin-top: -50px; font-size: 9px">
				导演&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>${sessionScope.movie.director }</span>
			</p>
			<p style="margin-left: 100px; margin-top: -10px; font-size: 9px">
				时长&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>${sessionScope.movie.timelen }</span>
			</p>

			<hr
				style="border-top: 1px solid #DDDDDD; width: 233px; margin-left: 15px; margin-top: 16px" />

			<dl class="liebiao">
				<dd>
					<span>影院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>cupcup国际影城
				</dd>
				<dd>
					<span>影厅&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>${sessionScope.moviescene }号厅-cupcup电影网购票</dd>
				<dd>
					<span>版本&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>${type }</dd>
				<dd>
					<span>场次&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>${stime }-${etime }</dd>
				<dd>
					<span>票价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>¥${price }/张<span>（含服务费¥3.5）</span>
				</dd>
			</dl>
			...
			<ul class="zuoweipiao">
				<li style="margin-left: 60px"><img src="img/log7.png">
				<p id="p1"></p></li>
				<li><img src="img/log7.png">
				<p id="p2"></p></li>
				<br />
				<br />
				<li style="margin-left: 60px"><img src="img/log7.png">
			...
			<form>
				<input type="button" id="zuizhongtijiao" class="btn btn-info btn-lg"
					value="提交订单"
					style="background-color: #FF8F0B; border-color: #FF8F0B; width: 230px; margin-left: 16px; margin-top: 15px;">
			</form>

			<hr
				style="border-top: 1px solid #DDDDDD; width: 233px; margin-left: 15px; margin-top: 16px" />
			<img style="margin-left: 20px; border: #FFF solid 1px;"
				src="img/log8.png"> <a
				href="gouPiaoController?op=dianYingPiao"><button
					class="btn btn-info btn-lg"
					style="width: 230px; height: 40px; background-color: #FF8F0B; margin-left: 15px">
					<p style="font-size: 18px">查看电影票</p>
				</button></a>
		</div>
	...
	<div id="tishi">
		...
		<hr
			style="border-top: 1px solid #DDDDDD; width: 950px; position: absolute; margin-left: 15px; margin-top: 50px;" />
