...
$.idealforms.errors = {
  ...
  number: '一定是数哟.',
  digits: '这一定要是数字哟.',
  name: '这至少有3个字符长，并且必须包含字母哟.',
  username: '这一项的长度在4~32个字符之间，但是开头必须是字母。你可以使用字母、数字、下划线和点(.).',
  pass: '长度至少为6个字符，一定至少要包括一个数字，一个小写字母，一个大写字母.',
  strongpass: '长度至少为8个字符，一定至少要包括一个数字，一个小写字母，一个大写字母或者是特殊符号.',
  email: '必须是有效的电子邮件地址.<em>（如user@gmail.com）</em>',
  ...
  url: '必须是有效的连接 <em>(如www.google.com)</em>',
  ...
  date: '一定要是个有效的日期. <em>(e.g. {0})</em>',
  dob: '必须是一个有效的出生日期.',
  exclude: '"{0}" 是不允许的.',
  excludeOption: '{0}',
  equalto: 'Must be the same value as <strong>"{0}"</strong>',
  extension: '文件必须有一个有效的扩展名. <em>(如 "{0}")</em>',
...
var _defaults = {
  ...
  customFlags: {},
  globalFlags: '',
  onFail: function() { alert('表单还没有填完整哟') },
  responsiveAt: 'auto',
  disableCustom: ''
}
