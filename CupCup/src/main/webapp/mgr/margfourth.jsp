	...
	<div class="div1">
		...
		<div style="width: 150px;; height: 650px; border: 1px solid #E6E6FA;">
			...
			<div class="div2" style="margin-top: -320px;">
				...
				<form action="mgrController?op=showdeleteuser" method="post"
					enctype="multipart/form-data">


					<div class="input-group"
						style="width: 300px; outline-style: none; margin-top: 15px; margin-left: 120px;">
						<input name="u_name" type="text" class="form-control"
							placeholder="请输入要查找的用户名"
							style="border-radius: 20px; border-color: #ef4238; outline-style: none; margin-bottom: 10px;">
						<input type="submit" style="margin-left: 200px;" value="搜索"
							class="sth">
					</div>
					<br> <img style="margin-top: 40px; margin-left: 90px;"
						src="${movie.cover }" width="170px;" height="190px;">
					<left>
					<div
						style="float: right; font-size: 17px; color: black; margin-right: 200px; margin-top: 50px;">
						用户名:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>${user.u_name }</span><br>
						<br>
						性别:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span>${user.sex }</span><br>
						<br> 邮箱:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>${user.email }</span><br>
						<br> 电话:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>${user.tel }</span>
					</div>
					</left>
				...
				<form action="mgrController?op=deleteuser&u_name=${user.u_name}"
					method="post">
					<input type="submit" value="删除用户" class="sth"
						style="margin-top: 250px; margin-right: -120px;"> <br>
					<c:forEach items="${yes}">
						<c:if test="${yes != null }">
