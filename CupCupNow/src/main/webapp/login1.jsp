...
<body>
        ...
        <div style="margin:0px auto; width:1000px; height:600px; margin-top:-10px">
            <div style="height:2px; width:100%; background-color: #CCC; margin-top:34px"><h5 style="margin-left:350px; position:absolute; font-size:36px; margin-top:-28px">管理员，请先登录！</h5></div>
            
           
            <div class="login-left" style="border-color: #fff;">
                <ul>
                    <li class="den1"></li>
                    
                    
                    <li class="den3" style="margin-left: -30px;">
                         <img src="img/regist/A}_XA8}YDTNG46A5RI09WRL.jpg" />
                         <h3 style="font-size:18px;margin-left:125px; margin-top:-100px"><h3>
                    </li>
                </ul>
            </div>
             
            
            <div class="login-right"style="margin-right: 250px;margin-top: -300px;">
            <div id="main">
               <div class="container clearfix">
                    <div class="row">
                         <div class="eightcol last">
<!-- Begin Form -->
                                <form action="UserController?op=login1" id="my-form" style="border-color: #FFF; margin-top:-10px" method="post">
                                      <div>        
