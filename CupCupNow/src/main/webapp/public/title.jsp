...
<html>
    ...
    <a href="#" class="tou">联系我们</a>
    <a href="#" class="tou">加入我们</a>
    <a href="#" class="tou">友情链接</a>
    ...
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<c:if test="${user==null}">
		                ...
		                <ul class="dropdown-menu" style="background-color: #fff; color:#ef4238; width:30px; margin-right:100px;">
							...
							<a href="register.html"><span class="glyphicon glyphicon-user"></span> 注册</a></button></li>
						</ul>
					</c:if>	    		
                        ...
                        <ul class="navContent" style="width:250px;margin-left:450px;" >
                            <li >
                                <ul>
									...
									<li><a href="movieController?op=showFirst&type=最新&pageNum=1">最新上映</a></li> 
									<li><a href="movieController?op=showFirst&type=热门&pageNum=1">真在热播</a></li> 
